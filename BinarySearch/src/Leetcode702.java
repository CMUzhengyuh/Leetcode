...
public class Leetcode702 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(search(new ArrayReader(test1Nums), 8));
        System.out.println(search(new ArrayReader(test1Nums), 9));

        int[] test2Nums = new int[] {0};
        System.out.println(search(new ArrayReader(test2Nums), 0));
        System.out.println(search(new ArrayReader(test2Nums), -1));
    }
}
